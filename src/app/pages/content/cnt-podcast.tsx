    ...
    <div className="bg-white px-10 py-12 min-h-screen">
      ...
      <div className="mb-20">
        <h2 className="text-4xl font-bold text-center text-gray-900 mb-12 max-w-4xl mx-auto">
          Extend your reach by catering to audiences with audio content
          preferences
        </h2>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              ...
              distribution across podcast directories (i.e. Spotify, Apple
              Podcasts, etc.)
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-20">
        ...
        <div className="max-w-xl">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            Create a website page, landing page, or blog post featuring your
            podcast episodes with our Podcast Episode Module to easily publish
            and share.
          </p>
        </div>
      </div>
      ...
      <div className="mt-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 items-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900">Create Content</h2>
        ...
        <div className="border-t border-gray-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 items-center border-b">
            ...
            <div className="py-6 border-l text-gray-600 text-center px-6">
              Includes custom targeting by device type, country, referral URL,
              and more.
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 items-center border-b">
            ...
            <div className="py-6 border-l text-sm text-gray-600 px-6">
              Up to 30 total website pages. Includes HubSpot branding. Favicon
              not customizable.
            </div>

            <div className="py-6 border-l text-sm text-gray-600 px-6">
              Up to 10K website pages. Includes personalization, A/B testing,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 border-b items-center">
            ...
            <div className="py-6 border-l text-sm text-gray-600 px-6">
              Create up to 100 consent banners with different geotargeting
              rules, languages, and templates. Includes support for GPC signals.
              Allow visitors to update their consent preferences.
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 border-b items-center">
            ...
            <div className="py-6 border-l text-sm text-gray-600 px-6">
              Includes content library module, plus gated access and remove
              branding.
            </div>
          </div>
      ...
      <div className="mt-32">
        ...
        <div className="border-t border-gray-300">
          ...
          <div className="py-6 border-t text-sm text-gray-500 col-span-3 text-center">
            View the Product & Services Catalog for full technical limits and
            definitions
          </div>
        </div>
      </div>
