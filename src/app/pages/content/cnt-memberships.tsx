  ...
  <div className="flex flex-col gap-4 w-fit">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="max-w-xl text-center lg:text-left">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">
              Deliver your web content to specific segments of customers
            </h3>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
              We get it. Prospects aren't the only people visiting your website.
              You have customers, partners, resellers, and other stakeholders you do business with.
            </p>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mt-4">
              That's where Memberships come in. With Content Hub, you can leverage access groups
              to allow only specific customers to access a section of your site.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-20">
        ...
        <div className="max-w-xl text-center lg:text-left">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-6 leading-snug">
            Create personalized membership pages
          </h2>
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
            With Memberships, you'll be able to fully leverage the power of dynamic content
            and the CRM together to create secure yet personalized 'profile pages' for your customers.
          </p>
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed mt-4">
            Contextualize the content shown to each user to provide membership-driven materials
            such as recent purchase information, upcoming appointments with your company, and more.
            With Memberships, you'll be able to create a membership-driven website that your
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-20">
        ...
        <div className="max-w-xl text-center lg:text-left">
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed mt-4">
            Create exclusive content for leads and customers. Control access to this content
            easily by using access groups, which automatically update as new contacts qualify.
          </p>
        </div>
      </div>
      ...
      <div className="mt-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 items-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">Create Content</h2>
      ...
      <div className="mt-32">
        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-12">Manage Content</h2>
          ...
          <div className="bg-white rounded-lg w-full max-w-md mx-4">
            ...
            <div className="p-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600 mb-6">
                <li>Basic membership features</li>
