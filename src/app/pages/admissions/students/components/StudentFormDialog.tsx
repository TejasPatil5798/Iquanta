...
export function StudentFormDialog({
  ...
  const [formValues, setFormValues] =
    useState<StudentFormValues>(mergedInitialValues);

  React.useEffect(() => {
    setFormValues(mergedInitialValues);
  }, [mergedInitialValues, open]);

  const handleChange = <K extends keyof StudentFormValues>(
    key: K,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] max-w-5xl mt-6 overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {mode === "edit" ? "Edit Student Profile" : "Add Student Profile"}
          </DialogTitle>
        </DialogHeader>
        ...
        <form className="space-y-8" onSubmit={handleSubmit}>
          <section className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Capture the core admissions and contact information.
              </p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(event) =>
                    handleChange("enrollmentDate", event.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  id="counselor"
                  value={formValues.counselor}
                  onChange={(event) =>
                    handleChange("counselor", event.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Select
                  value={formValues.applicationStage}
                  onValueChange={(value) =>
                    handleChange("applicationStage", value)
                  }
                >
                  <SelectTrigger>
          ...
          <section className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Useful for verification and counselling follow-up.
              </p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(event) =>
                    handleChange("guardianPhone", event.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
          ...
          <section className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Capture educational background for admissions review.
              </p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              <div className="space-y-2">
                ...
                <Input
                  id="tenthBoard"
                  value={formValues.tenthBoard}
                  onChange={(event) =>
                    handleChange("tenthBoard", event.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(event) =>
                    handleChange("tenthPercentage", event.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  id="twelfthBoard"
                  value={formValues.twelfthBoard}
                  onChange={(event) =>
                    handleChange("twelfthBoard", event.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(event) =>
                    handleChange("twelfthPercentage", event.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  id="graduationCourse"
                  value={formValues.graduationCourse}
                  onChange={(event) =>
                    handleChange("graduationCourse", event.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={formValues.graduationPercentage}
                  onChange={(event) =>
                    handleChange("graduationPercentage", event.target.value)
                  }
                />
              </div>
              <div className="space-y-2 md:col-span-2 xl:col-span-3">
          ...
          <section className="space-y-4">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Store uploaded document metadata for admissions checks.
                </p>
              </div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder="e.g. 12th-marksheet.pdf"
                      />
                    </div>
                    <div className="space-y-2">
                      <Label>Status</Label>
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleDocumentChange(index, "status", value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue placeholder="Select status" />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        value={document.url || ""}
                        onChange={(event) =>
                          handleDocumentChange(index, "url", event.target.value)
                        }
                    ...
                    <div className="space-y-2 md:col-span-2 xl:col-span-3">
                      ...
                      <Textarea
                        ...
                        rows={2}
                        placeholder="Verification remarks or missing pages note"
                      />
                    </div>
                  </div>
                </div>
