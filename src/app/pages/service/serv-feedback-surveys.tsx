...
export function ServFeedbackSurveys() {
  // Modal states
    ...
    <div className="bg-white px-4 sm:px-6 md:px-8 lg:px-10 py-8 md:py-12 min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 mb-20">
        ...
        <div className="max-w-xl text-center lg:text-left">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">
            Keep a pulse on customer <br />
            feedback
          </h1>
          <p className="text-gray-600 text-base sm:text-lg mb-6">
            Ensure your customers feel heard and valued throughout their journey with
            CRM-powered surveys — so they stay with you longer.
          </p>
        ...
        <div className="w-full lg:w-[500px]">
          <img
            src="https://www.w-4.ch/hubfs/W4%20Website/HubSpot-Productpages/Customer%20loyalty%20-%20Analyse%20(1)-1.png"
      ...
      <div className="mb-20">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-gray-900 mb-12 max-w-4xl mx-auto">
          Run feedback surveys to truly understand your <br />
          customers and spot opportunities to delight them
        </h2>
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="w-full lg:w-[550px]">
            <img
              src="https://www.marketingallday.com/hubfs/Website%20Redesign%20(2024)/Software/Support%20Software/Support%20-%20Screenshot%204%20v2.png"
              alt="Surveys"
              className="w-full rounded-lg shadow-md"
            />
          </div>
          <div className="max-w-xl text-center lg:text-left">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">
              Send surveys to capture the feedback <br />
              your business needs
            </h3>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
              Learn what your customers really think with custom
              surveys and feedback tools. Tailor your survey to your
              business needs with a diverse array of question types
              and a customizable template.
            </p>
            <p className="text-gray-600 text-base sm:text-lg mt-2">
              Send your custom survey via web link or email, then
              efficiently share insights with your teams so you can
              deepen customer relationships and improve retention.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-20">
        <div className="max-w-xl text-center lg:text-left">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-6 leading-snug">
            Stay on top of key customer service KPIs
          </h2>
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
            Want to get a read on how loyal your customers are?
            Curious how customers feel about the helpfulness of
            your customer service experience — or your individual
            support agents?
          </p>
          <p className="text-gray-600 text-base sm:text-lg mt-2">
            HubSpot will help you choose the most appropriate
            feedback tool and delivery method for your specific
            goals so you can increase response rates and build a
            baseline of data over time.
          </p>
          <p className="text-gray-600 text-base sm:text-lg mt-2">
            Choose from pre-built Net Promoter Score (NPS),
            Customer Effort Score (CES), and customer
            satisfaction (CSAT) surveys to gauge customer loyalty
            at every touch point.
          </p>
        </div>
        <div className="w-full lg:w-[600px]">
          <img
            src="https://www.hubspot.com/hs-fs/hubfs/Paywall/MON-611-service-hub-paywalls/CF%20Create%20survey%20email-1.png?width=567&height=335&name=CF%20Create%20survey%20email-1.png"
            alt="KPIs"
            className="w-full rounded-lg shadow-md"
          />
        </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-20">
        ...
        <div className="max-w-xl text-center lg:text-left">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-6 leading-snug">
            Use feedback surveys to uncover growth <br />
            opportunities
          </h2>
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
            Built-in feedback dashboards let you monitor
            performance and take immediate action on your
            insights.
          </p>
          <p className="text-gray-600 text-base sm:text-lg mt-2">
            Send a survey and watch as data starts flowing into
            your dashboard — where it will be organized,
            visualized, and analyzed.
          </p>
          <p className="text-gray-600 text-base sm:text-lg mt-2">
            You’ll be able to spot opportunities to improve specific
            points in the customer journey, see how your
            customers’ happiness compares to industry averages,
            and identify trends that help you create an even better
          ...
          <div className="bg-white rounded-lg w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
                <li>Advanced feedback surveys (NPS, CES, CSAT)</li>
                <li>Customer success workspace and health scoring</li>
                <li>Help desk automation and knowledge base</li>
          ...
          <div className="bg-white rounded-lg w-full max-w-md mx-4">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600">
                Upgrade to <strong>Service Hub Professional</strong> to unlock advanced surveys (NPS, CES, CSAT), automation, and remove HubSpot branding.
              </p>
