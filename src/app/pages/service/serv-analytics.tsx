    ...
    <div className="bg-white px-4 sm:px-6 md:px-8 lg:px-10 py-8 md:py-12 min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 mb-20">
        ...
        <div className="max-w-xl text-center lg:text-left">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">
            Improve your customer <br />
            service team's success
          </h1>
          <p className="text-gray-600 text-base sm:text-lg mb-6">
            Use HubSpot's default reports to help you deliver efficient and authentic
            customer service.
          </p>
        ...
        <div className="w-full lg:w-[400px]">
          <img
            src="https://d3f1iyfxxz8i1e.cloudfront.net/courses/course_image/8bb140ab3c7d.jpg"
            alt="Analytics"
      ...
      <div className="mb-20">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-gray-900 mb-12 max-w-4xl mx-auto">
          Understand what your customers think about your <br />
          support
        </h2>
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="w-full lg:w-[550px]">
            <img
              src="https://community.hubspot.com/t5/image/serverpage/image-id/126671i5A4FB9DE29AC3828/image-size/large?v=v2&px=999"
          ...
          <div className="max-w-xl text-center lg:text-left">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">
              Improve your customer experience with <br />
              actionable insights
            </h3>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
              Quickly uncover insights about your support team.
              Easily visualize data on rep productivity, average ticket
              response time, post-support survey scores, overall
              support volume, and more.
            </p>
            <p className="text-gray-600 text-base sm:text-lg mt-2">
              Let your support team focus on what matters most:
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-20">
        <div className="max-w-xl text-center lg:text-left">
          <h3 className="text-2xl font-semibold text-gray-900 mb-4">
            Gain quick insight on service rep <br />
            productivity
          </h3>
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
            Understand how efficiently your reps are
            resolving customer issues. With out-of-the-box
            analytics reports, you gain insight into average time to
            close, response time on chats, and ticket volume in a
            matter of seconds - and resolve bottlenecks within
            your team before they pile up.
          </p>
        </div>
        <div className="w-full lg:w-[600px]">
          <img
            src="https://community.hubspot.com/t5/image/serverpage/image-id/55317iC02420331BF1E2E3?v=v2"
            alt="Rep productivity"
            className="w-full rounded-lg shadow-md"
          />
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-20">
        ...
        <div className="max-w-xl text-center lg:text-left">
          <h3 className="text-2xl font-semibold text-gray-900 mb-4">
            Map how your customers leverage your <br />
            support resources
          </h3>
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
            Make your customers feel seen and valued by
            understanding their pain points. Service analytics
            provides easily digestible reports on vital customer
            service data such as how your customers use your
            knowledge base, chat wait time, customer satisfaction
            scores, and more.
          </p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
                <li>Advanced service analytics and reporting</li>
          ...
          <div className="bg-white rounded-lg w-full max-w-md mx-4">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600">
                Upgrade to <strong>Service Hub Professional</strong> to unlock advanced analytics, automation, and remove HubSpot branding.
              </p>
