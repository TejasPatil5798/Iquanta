    ...
    <div className="bg-white px-4 sm:px-6 md:px-8 lg:px-10 py-8 md:py-12 min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 mb-20">
        <div className="max-w-xl text-center lg:text-left">
          ...
          <p className="text-gray-600 text-base sm:text-lg mb-6">
            Sales workspace unifies pipeline generation and closing activities in one place,
            making it easy for you to prioritize and execute the most impactful sales
            actions to hit your sales goals.
          </p>
        ...
        <div className="w-full lg:w-[500px]">
          <img
            src="https://7448179.fs1.hubspotusercontent-na1.net/hub/7448179/hubfs/HubSpot_02.png"
            alt="Sales workspace"
      ...
      <div className="mb-20">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-gray-900 mb-12 max-w-4xl mx-auto">
          When you upgrade, you get more than features
        </h2>

        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="w-full lg:w-[550px]">
            <img
              src="https://7448179.fs1.hubspotusercontent-na1.net/hub/7448179/hubfs/HubSpot_03.png"
              alt="Streamlined sales"
              className="w-full rounded-lg shadow-md"
            />
          </div>
          <div className="max-w-xl text-center lg:text-left">
            ...
            <p className="text-gray-600 text-base sm:text-lg">
              Qualify leads, prioritize deals, and plan your day all in one place.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 mb-20">
        <div className="max-w-xl text-center lg:text-left">
          ...
          <p className="text-gray-600 text-base sm:text-lg">
            Enhance your sales pipeline and effectively close deals using guided actions.
          </p>
        </div>
        <div className="w-full lg:w-[600px]">
          <img
            src="https://7448179.fs1.hubspotusercontent-na1.net/hub/7448179/hubfs/HubSpot_01.png"
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 mb-20">
        <div className="w-full lg:w-[600px]">
          <img
            src="https://www.hubspot.com/hs-fs/hubfs/SUIs_SalesHub_Contacts-UI%20(2)%20(1).png?width=540&name=SUIs_SalesHub_Contacts-UI%20(2)%20(1).png"
            alt="Plan and measure"
            className="w-full rounded-lg shadow-md"
          />
        </div>
        <div className="max-w-xl text-center lg:text-left">
          ...
          <p className="text-gray-600 text-base sm:text-lg">
            See your upcoming meetings, understand performance, and track deals easily.
          </p>
        </div>
      </div>
